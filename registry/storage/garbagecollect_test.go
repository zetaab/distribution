...
func TestDeleteManifestIfTagNotFound(t *testing.T) {
	...
	// this should return manifest digest 4bb38a1629b39e6649ba6bb00ee37700824fce523266040ba56a5cf69ad198c5
	_, err = manifestService.Put(ctx, manifest1)
	if err != nil {
		t.Fatalf("manifest upload failed: %v", err)
	}

	// this should return manifest digest 9af99e264d0cdc3b7fc513ab068ff478d6bd7e70e7099629796a0ca639e24e32
